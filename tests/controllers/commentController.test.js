...
const validToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiaWF0IjoxNTMzMDc3ODcyfQ.YibyD9L42qZB-mFpviFlVBFzXM9-dsnLLzh9Y48-63Y';
...
describe('Tests for comment controller', () => {
  ...
  describe('Tests for comment', () => {
    ...
    it('Should not create a comment if required fields are absent', (done) => {
      chai.request(app)
        .post('/api/articles/how-to-train-your-dragon-cjkjul5200000govbk1904gde/comments')
        .set('authorization', `Bearer ${validToken}`)
        .send(invalidComment)
